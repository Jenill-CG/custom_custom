...
def create_attendance_pdf(pdf, column_widths, column_names, image_path, info_values, df, format_option):
    ...
    if format_option == 'Pen Paper Assessment':
        ...
        pdf.cell(28, 0.5, 'LANGUAGE OF THE T.A.', border='LR', align='C')
        ...
        pdf.cell(28, 4.5, '(OTHER THAN HINDI)', border='LBR', align='C')  # Empty cell under SUBJECT 2
...
def main():
    ...
    st.markdown("<div class='custom-header' style='background-color: #87CEEB; text-align: center;padding: 15px; font-size: 40px;font-weight: bold;color: #FFFFFF; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);'>CGI's Custom ID Builder</div>", unsafe_allow_html=True)
